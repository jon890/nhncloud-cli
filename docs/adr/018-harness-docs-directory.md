...
- **결정**: 항목이 계속 append 되는 누적 docs 를 단일 파일이 아니라 **항목 1개 = 파일 1개 + INDEX 라우터**로 운영한다.
  ...
  - 회피 패턴: `.agents/skills/_shared/common-pitfalls.md`·`code-review-pitfalls.md` → `_shared/pitfalls/{plan,code-review,team}/<slug>.md`(내용 기반 slug — 내부 참조라 번호 불요) + `pitfalls/INDEX.md` 라우터.
